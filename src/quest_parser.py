...
def get_file_content_as_lines(data_path_tuple):
    ...
    file_path = data_path + subject + '_quest.csv'
...
def parse_ordered_dictionary(lines):
    order_dict = OrderedDict({cond: dict(
        start=None,
        end=None,
        panas=None,
        stai=None,
    ...
    panases = get_questionary_lists('# PANAS', lines)
    stais = get_questionary_lists('# STAI', lines, 7)
    dims = get_questionary_lists('# DIM', lines, 3)
